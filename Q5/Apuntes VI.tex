...
\begin{itemize}
  ...
  \textcolor{blue}{16:16. The use of the analogy to express who the public, internet and data can be confused and doenst really seem to be appropriate.} % Although i am not quite sure the representatio can be considered a visualization.
